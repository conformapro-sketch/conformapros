...
export function BibliothequeDataGrid({
  ...
  return (
    <div className="rounded-md border bg-card w-full">
      <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent relative">
        <Table className="min-w-[700px] lg:min-w-full table-fixed w-full">
