-- Ensure Super Admin has absolutely no restrictions in get_all_client_users
...
BEGIN
  ...
  -- Super Admin and Admin Global have full access with NO restrictions
  -- Client admins need specific client access
  IF NOT (
    is_super_admin OR
    is_admin_global OR
